    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="{{ route('simpanPegawai')}}" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="no_induk" class="form-control" required>
                        <label>Nama Pegawai</label>
                        <input type="text" name="nama" class="form-control" required>
                        <label for="">Divisi</label>
                        <select name="divisi" id="" class="divisi form-control" required>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="{{route('updatePegawai')}}" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
                    @csrf
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Jabatan</label>
                        <select name="jabatan" class="jabatan form-control" id="jabatan" required>
                            <option value="">Pilih Jenis</option>
                            <option value="manager">Manager</option>
                            <option value="Assisten Manager">Assisten Manager</option>
                            <option value="supervisor">Supervisor</option>
                    ...
                    <div class="form-group">
                        <label for="">Lampiran</label>
                        <div id="testing2" class="form-group"></div>
                        <input type="file" id="new_lampiran" name="new_lampiran" class="form-control">
                    </div>
